...
public struct Vector<T> : IEquatable<Vector<T>>, IFormattable where T : struct
{
	...
	public Vector(Span<T> values)
	{
		...
		if (typeof(T) == typeof(byte) || typeof(T) == typeof(sbyte) || typeof(T) == typeof(ushort) || typeof(T) == typeof(short) || typeof(T) == typeof(uint) || typeof(T) == typeof(int) || typeof(T) == typeof(ulong) || typeof(T) == typeof(long) || typeof(T) == typeof(float) || typeof(T) == typeof(double))
		{
			...
			{
				throw new IndexOutOfRangeException(SR.Format("At least {0} element(s) are expected in the parameter \"{1}\".", Count, "values"));
			}
	...
	internal static T DotProduct(Vector<T> left, Vector<T> right)
	{
		...
		if (typeof(T) == typeof(byte))
		{
			return (T)(object)(byte)((byte)((byte)((byte)((byte)((byte)((byte)((byte)((byte)((byte)((byte)((byte)((byte)((byte)((byte)((byte)(0 + (byte)(left.register.byte_0 * right.register.byte_0)) + (byte)(left.register.byte_1 * right.register.byte_1)) + (byte)(left.register.byte_2 * right.register.byte_2)) + (byte)(left.register.byte_3 * right.register.byte_3)) + (byte)(left.register.byte_4 * right.register.byte_4)) + (byte)(left.register.byte_5 * right.register.byte_5)) + (byte)(left.register.byte_6 * right.register.byte_6)) + (byte)(left.register.byte_7 * right.register.byte_7)) + (byte)(left.register.byte_8 * right.register.byte_8)) + (byte)(left.register.byte_9 * right.register.byte_9)) + (byte)(left.register.byte_10 * right.register.byte_10)) + (byte)(left.register.byte_11 * right.register.byte_11)) + (byte)(left.register.byte_12 * right.register.byte_12)) + (byte)(left.register.byte_13 * right.register.byte_13)) + (byte)(left.register.byte_14 * right.register.byte_14)) + (byte)(left.register.byte_15 * right.register.byte_15));
		}
		if (typeof(T) == typeof(sbyte))
		{
			return (T)(object)(sbyte)((sbyte)((sbyte)((sbyte)((sbyte)((sbyte)((sbyte)((sbyte)((sbyte)((sbyte)((sbyte)((sbyte)((sbyte)((sbyte)((sbyte)((sbyte)(0 + (sbyte)(left.register.sbyte_0 * right.register.sbyte_0)) + (sbyte)(left.register.sbyte_1 * right.register.sbyte_1)) + (sbyte)(left.register.sbyte_2 * right.register.sbyte_2)) + (sbyte)(left.register.sbyte_3 * right.register.sbyte_3)) + (sbyte)(left.register.sbyte_4 * right.register.sbyte_4)) + (sbyte)(left.register.sbyte_5 * right.register.sbyte_5)) + (sbyte)(left.register.sbyte_6 * right.register.sbyte_6)) + (sbyte)(left.register.sbyte_7 * right.register.sbyte_7)) + (sbyte)(left.register.sbyte_8 * right.register.sbyte_8)) + (sbyte)(left.register.sbyte_9 * right.register.sbyte_9)) + (sbyte)(left.register.sbyte_10 * right.register.sbyte_10)) + (sbyte)(left.register.sbyte_11 * right.register.sbyte_11)) + (sbyte)(left.register.sbyte_12 * right.register.sbyte_12)) + (sbyte)(left.register.sbyte_13 * right.register.sbyte_13)) + (sbyte)(left.register.sbyte_14 * right.register.sbyte_14)) + (sbyte)(left.register.sbyte_15 * right.register.sbyte_15));
		}
		if (typeof(T) == typeof(ushort))
		{
			return (T)(object)(ushort)((ushort)((ushort)((ushort)((ushort)((ushort)((ushort)((ushort)(0 + (ushort)(left.register.uint16_0 * right.register.uint16_0)) + (ushort)(left.register.uint16_1 * right.register.uint16_1)) + (ushort)(left.register.uint16_2 * right.register.uint16_2)) + (ushort)(left.register.uint16_3 * right.register.uint16_3)) + (ushort)(left.register.uint16_4 * right.register.uint16_4)) + (ushort)(left.register.uint16_5 * right.register.uint16_5)) + (ushort)(left.register.uint16_6 * right.register.uint16_6)) + (ushort)(left.register.uint16_7 * right.register.uint16_7));
		}
		if (typeof(T) == typeof(short))
		{
			return (T)(object)(short)((short)((short)((short)((short)((short)((short)((short)(0 + (short)(left.register.int16_0 * right.register.int16_0)) + (short)(left.register.int16_1 * right.register.int16_1)) + (short)(left.register.int16_2 * right.register.int16_2)) + (short)(left.register.int16_3 * right.register.int16_3)) + (short)(left.register.int16_4 * right.register.int16_4)) + (short)(left.register.int16_5 * right.register.int16_5)) + (short)(left.register.int16_6 * right.register.int16_6)) + (short)(left.register.int16_7 * right.register.int16_7));
		}
		if (typeof(T) == typeof(uint))
		{
			return (T)(object)(0 + left.register.uint32_0 * right.register.uint32_0 + left.register.uint32_1 * right.register.uint32_1 + left.register.uint32_2 * right.register.uint32_2 + left.register.uint32_3 * right.register.uint32_3);
		}
		if (typeof(T) == typeof(int))
		{
		...
		if (typeof(T) == typeof(ulong))
		{
			return (T)(object)(0 + left.register.uint64_0 * right.register.uint64_0 + left.register.uint64_1 * right.register.uint64_1);
		}
		if (typeof(T) == typeof(long))
		{
			return (T)(object)(0 + left.register.int64_0 * right.register.int64_0 + left.register.int64_1 * right.register.int64_1);
		}
		if (typeof(T) == typeof(float))
		{
