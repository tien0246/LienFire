...
{
	private static readonly WellKnownAccount[] accounts = new WellKnownAccount[66]
	{
	...
	{
		WellKnownAccount[] array = accounts;
		foreach (WellKnownAccount wellKnownAccount in array)
		{
