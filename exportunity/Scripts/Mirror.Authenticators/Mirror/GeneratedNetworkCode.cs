...
public static class GeneratedNetworkCode
{
	...
	{
		return new BasicAuthenticator.AuthRequestMessage
		{
			authUsername = reader.ReadString(),
			authPassword = reader.ReadString()
		};
	}
	...
	{
		return new BasicAuthenticator.AuthResponseMessage
		{
	...
	public static DeviceAuthenticator.AuthRequestMessage _Read_Mirror_002EAuthenticators_002EDeviceAuthenticator_002FAuthRequestMessage(NetworkReader reader)
	{
		return new DeviceAuthenticator.AuthRequestMessage
		{
			clientDeviceID = reader.ReadString()
		};
	}

	public static void _Write_Mirror_002EAuthenticators_002EDeviceAuthenticator_002FAuthRequestMessage(NetworkWriter writer, DeviceAuthenticator.AuthRequestMessage value)
	{
		writer.WriteString(value.clientDeviceID);
	}

	public static DeviceAuthenticator.AuthResponseMessage _Read_Mirror_002EAuthenticators_002EDeviceAuthenticator_002FAuthResponseMessage(NetworkReader reader)
	{
		return default(DeviceAuthenticator.AuthResponseMessage);
	}

	public static void _Write_Mirror_002EAuthenticators_002EDeviceAuthenticator_002FAuthResponseMessage(NetworkWriter writer, DeviceAuthenticator.AuthResponseMessage value)
	{
	}
	...
	public static void InitReadWriters()
	{
		...
		Writer<DeviceAuthenticator.AuthRequestMessage>.write = _Write_Mirror_002EAuthenticators_002EDeviceAuthenticator_002FAuthRequestMessage;
		Writer<DeviceAuthenticator.AuthResponseMessage>.write = _Write_Mirror_002EAuthenticators_002EDeviceAuthenticator_002FAuthResponseMessage;
		...
		Reader<DeviceAuthenticator.AuthRequestMessage>.read = _Read_Mirror_002EAuthenticators_002EDeviceAuthenticator_002FAuthRequestMessage;
		Reader<DeviceAuthenticator.AuthResponseMessage>.read = _Read_Mirror_002EAuthenticators_002EDeviceAuthenticator_002FAuthResponseMessage;
	}
}
