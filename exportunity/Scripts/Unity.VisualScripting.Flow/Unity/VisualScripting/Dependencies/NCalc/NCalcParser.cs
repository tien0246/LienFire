...
public class NCalcParser : Parser
{
	...
	public ncalcExpression_return ncalcExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(ncalcExpression_return.Tree, (IToken)ncalcExpression_return.Start, (IToken)ncalcExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			ncalcExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)ncalcExpression_return.Start, input.LT(-1), ex);
		}
	...
	public logicalExpression_return logicalExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(logicalExpression_return.Tree, (IToken)logicalExpression_return.Start, (IToken)logicalExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			logicalExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)logicalExpression_return.Start, input.LT(-1), ex);
		}
	...
	public conditionalExpression_return conditionalExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(conditionalExpression_return.Tree, (IToken)conditionalExpression_return.Start, (IToken)conditionalExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			conditionalExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)conditionalExpression_return.Start, input.LT(-1), ex);
		}
	...
	public booleanAndExpression_return booleanAndExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(booleanAndExpression_return.Tree, (IToken)booleanAndExpression_return.Start, (IToken)booleanAndExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			booleanAndExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)booleanAndExpression_return.Start, input.LT(-1), ex);
		}
	...
	public bitwiseOrExpression_return bitwiseOrExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(bitwiseOrExpression_return.Tree, (IToken)bitwiseOrExpression_return.Start, (IToken)bitwiseOrExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			bitwiseOrExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)bitwiseOrExpression_return.Start, input.LT(-1), ex);
		}
	...
	public bitwiseXOrExpression_return bitwiseXOrExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(bitwiseXOrExpression_return.Tree, (IToken)bitwiseXOrExpression_return.Start, (IToken)bitwiseXOrExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			bitwiseXOrExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)bitwiseXOrExpression_return.Start, input.LT(-1), ex);
		}
	...
	public bitwiseAndExpression_return bitwiseAndExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(bitwiseAndExpression_return.Tree, (IToken)bitwiseAndExpression_return.Start, (IToken)bitwiseAndExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			bitwiseAndExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)bitwiseAndExpression_return.Start, input.LT(-1), ex);
		}
	...
	public equalityExpression_return equalityExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(equalityExpression_return.Tree, (IToken)equalityExpression_return.Start, (IToken)equalityExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			equalityExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)equalityExpression_return.Start, input.LT(-1), ex);
		}
	...
	public relationalExpression_return relationalExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(relationalExpression_return.Tree, (IToken)relationalExpression_return.Start, (IToken)relationalExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			relationalExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)relationalExpression_return.Start, input.LT(-1), ex);
		}
	...
	public shiftExpression_return shiftExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(shiftExpression_return.Tree, (IToken)shiftExpression_return.Start, (IToken)shiftExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			shiftExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)shiftExpression_return.Start, input.LT(-1), ex);
		}
	...
	public additiveExpression_return additiveExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(additiveExpression_return.Tree, (IToken)additiveExpression_return.Start, (IToken)additiveExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			additiveExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)additiveExpression_return.Start, input.LT(-1), ex);
		}
	...
	public multiplicativeExpression_return multiplicativeExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(multiplicativeExpression_return.Tree, (IToken)multiplicativeExpression_return.Start, (IToken)multiplicativeExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			multiplicativeExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)multiplicativeExpression_return.Start, input.LT(-1), ex);
		}
	...
	public unaryExpression_return unaryExpression()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(unaryExpression_return.Tree, (IToken)unaryExpression_return.Start, (IToken)unaryExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			unaryExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)unaryExpression_return.Start, input.LT(-1), ex);
		}
		...
		try
		{
			...
			case 3:
			{
				...
				if (num2 == 1)
				{
					...
					primaryExpression_return.value = new FunctionExpression(identifier_return?.value, (arguments_return?.value).ToArray());
				}
				break;
			}
			}
			...
			adaptor.SetTokenBoundaries(primaryExpression_return.Tree, (IToken)primaryExpression_return.Start, (IToken)primaryExpression_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			primaryExpression_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)primaryExpression_return.Start, input.LT(-1), ex);
		}
	...
	public value_return value()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(value_return.Tree, (IToken)value_return.Start, (IToken)value_return.Stop);
		}
		catch (RecognitionException ex2)
		{
			ReportError(ex2);
			Recover(input, ex2);
			value_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)value_return.Start, input.LT(-1), ex2);
		}
		return value_return;
	}
	...
	public identifier_return identifier()
	{
		...
		try
		{
			...
			case 1:
				...
				commonTree2 = (CommonTree)adaptor.Create(token);
				adaptor.AddChild(commonTree, commonTree2);
				identifier_return.value = new IdentifierExpression(token?.Text);
				break;
			case 2:
				commonTree = (CommonTree)adaptor.GetNilNode();
				...
				commonTree3 = (CommonTree)adaptor.Create(token2);
				adaptor.AddChild(commonTree, commonTree3);
				identifier_return.value = new IdentifierExpression((token2?.Text).Substring(1, (token2?.Text).Length - 2));
				break;
			}
			identifier_return.Stop = input.LT(-1);
			identifier_return.Tree = (CommonTree)adaptor.RulePostProcessing(commonTree);
			adaptor.SetTokenBoundaries(identifier_return.Tree, (IToken)identifier_return.Start, (IToken)identifier_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			identifier_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)identifier_return.Start, input.LT(-1), ex);
		}
	...
	public expressionList_return expressionList()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(expressionList_return.Tree, (IToken)expressionList_return.Start, (IToken)expressionList_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			expressionList_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)expressionList_return.Start, input.LT(-1), ex);
		}
	...
	public arguments_return arguments()
	{
		...
		try
		{
			...
			adaptor.SetTokenBoundaries(arguments_return.Tree, (IToken)arguments_return.Start, (IToken)arguments_return.Stop);
		}
		catch (RecognitionException ex)
		{
			ReportError(ex);
			Recover(input, ex);
			arguments_return.Tree = (CommonTree)adaptor.ErrorNode(input, (IToken)arguments_return.Start, input.LT(-1), ex);
		}
